...
export const ALL_TOOLS: AppTool[] = [
  ...
  },
  {
    ...
    category: 'incharge',
    subtab: 'exam',
    title: 'Exam Seating Matrix',
    titleHindi: 'परीक्षा सिटिंग प्लान',
    description: 'Generate room-wise alternate bench seating plan for exams',
    descriptionHindi: 'वार्षिक व बोर्ड परीक्षा कक्ष-वार सिटिंग अरेंजमेंट',
    iconName: 'Layers',
    colorBg: 'bg-teal-100 text-teal-700 dark:bg-teal-950/60 dark:text-teal-300'
  },
  {
