...
// Blank initial default state so website opens fresh without pre-filled school data
...
// Sample Demo Data for optional one-click loading
...
export const SAMPLE_STUDENTS: StudentResult[] = [
  {
    id: "std-1",
    srNo: "1402",
    rollNo: "1001",
...
export const SAMPLE_INCHARGES: InchargeAssignment[] = [
  {
    id: "inc-1",
...
export const SAMPLE_ANOMALIES: StudentAnomaly[] = [
  {
    id: "anm-1",
    srNo: "1402",
    studentName: "Aarav Sharma",
...
export const SAMPLE_ICT_ITEMS: ICTEquipment[] = [
  {
    id: "ict-1",
...
export const SAMPLE_LIBRARY_BOOKS: LibraryBook[] = [
  {
    id: "bk-1",
    accessionNo: "ACC-101",
...
export const SAMPLE_MDM_LOGS: MDMLog[] = [
  {
    date: "2026-07-30",
    totalEnrolled: 340,
    totalPresent: 310,
...
export const SAMPLE_APAR_RECORDS: AparIprRecord[] = [
  {
    id: "apar-1",
    employeeId: "RJPA20011502",
...
export const SAMPLE_AADHAAR_RECORDS: AadhaarPramanikaranRecord[] = [
  {
    id: "adh-1",
    personType: "Student",
    srNoOrEmpId: "1402",
...
export const SAMPLE_APAAR_RECORDS: ApaarIdRecord[] = [
  {
    id: "apr-1",
    srNo: "1402",
    studentName: "Aarav Sharma",
...
export const storage = {
  ...
  clearStaleData: () => {
    try {
      // Clear all shala_ keys from localStorage
      Object.values(KEYS).forEach(key => {
        localStorage.removeItem(key);
      });
      // Clear IndexedDB database if present
      if ('indexedDB' in window) {
        indexedDB.deleteDatabase('ShalaSahayakDB');
      }
