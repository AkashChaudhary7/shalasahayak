...
export const SeoManager: React.FC<SeoManagerProps> = ({
  ...
  useEffect(() => {
    ...
    if (currentHash === 'krida-shulk' || currentHash === 'krida-shulk-maker') {
      ...
      title = "उपयोग मार्गदर्शिकाएँ व सहायता केंद्र (Help Guides) | शाला सहायक";
      description = "शाला दर्पण प्रविष्टियाँ, PEEO आदेश जनरेटर, MDM दुग्ध गणना, 7th Pay Matrix व परीक्षा प्रभारियों हेतु विस्तृत हेल्प गाइड व ट्यूटोरियल।";
