  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl p-4 sm:p-6 shadow-xl border border-slate-200 dark:border-slate-800 space-y-6">
      ...
      <div className="space-y-2">
        ...
        {/* Mobile View Format Dropdown Selector */}
        <div className="block sm:hidden my-2">
          <div className="relative">
            <select
              value={selectedFormatId}
              onChange={(e) => setSelectedFormatId(e.target.value)}
              className="w-full bg-slate-900 dark:bg-slate-800 text-white font-extrabold text-xs py-2.5 px-3 pr-8 rounded-xl appearance-none border border-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-sm cursor-pointer"
            >
