...
import { InspireAwardInchargeModule } from '../incharge/InspireAwardInchargeModule';
import { UdiseInchargeModule } from '../incharge/UdiseInchargeModule';
...
interface WorkInchargeModuleProps {
  ...
  lang: Language;
  initialSubTab?: 'mdm' | 'transport' | 'lado' | 'scholarship' | 'elc' | 'exam' | 'qrcode' | 'dutyroster' | 'assembly' | 'inspire' | 'udise' | null;
...
export const WorkInchargeModule: React.FC<WorkInchargeModuleProps> = ({
  ...
  const [activeSubTab, setActiveSubTab] = useState<'mdm' | 'transport' | 'lado' | 'scholarship' | 'elc' | 'exam' | 'qrcode' | 'dutyroster' | 'assembly' | 'inspire' | 'udise' | null>(initialSubTab);
  ...
  if (activeSubTab === null) {
    const modules = [
      ...
      {
        id: 'inspire' as const,
        titleHi: 'इंस्पायर अवार्ड प्रभारी',
        titleEn: 'Inspire Award Incharge',
        descHi: 'बाल वैज्ञानिक विचार नामांकन, डीबीटी खाता सत्यापन, आइडिया बैंक व प्रमाणीकरण प्रपत्र',
        descEn: 'Student innovation nominations, idea bank, DBT tracking & verification certificates',
        iconName: 'award' as const
      },
      {
        id: 'udise' as const,
        titleHi: 'यू-डाइस+ (UDISE+) प्रभारी',
        titleEn: 'UDISE+ Incharge Portal',
        descHi: 'शिक्षक प्रोफाइल, विद्यालय संसाधन, छात्र मॉड्यूल (APAAR), विविध फॉरमेट्स व रिपोर्ट जनरेटर',
        descEn: 'Teacher profile, school facilities, student APAAR profile, formats & certificate generator',
  ...
  return (
    <div className="space-y-4">
      ...
      {/* INSPIRE AWARD INCHARGE MODULE */}
      {activeSubTab === 'inspire' && (
        <InspireAwardInchargeModule
          schoolProfile={schoolProfile}
          lang={lang}
          onBack={() => handleSubTabChange(null)}
        />
