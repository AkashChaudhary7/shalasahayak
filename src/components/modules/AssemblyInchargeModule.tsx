...
export const AssemblyInchargeModule: React.FC<AssemblyInchargeModuleProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 md:p-6 shadow-xl border border-slate-200 dark:border-slate-800 space-y-6 animate-fadeIn max-w-5xl mx-auto">
      ...
      {/* Primary Navigation Tabs - Mobile Dropdown Selector */}
      <div className="block sm:hidden mb-2">
        <label className="block text-[11px] font-bold text-slate-600 dark:text-slate-400 mb-1">
          {lang === 'hi' ? 'मॉड्यूल भाग चुनें (Select Section):' : 'Select Section:'}
        </label>
        <div className="relative">
          <select
            value={activeTab}
            onChange={(e) => setActiveTab(e.target.value as any)}
            className="w-full bg-amber-500 text-white font-black text-xs py-2.5 px-3 pr-8 rounded-xl appearance-none border border-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-400 shadow-sm cursor-pointer"
          >
            {[
      ...
      <div className="hidden sm:flex overflow-x-auto pb-1 gap-1.5 scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-700">
        {[
          { id: 'prayers', titleHi: '1. प्रार्थना व राष्ट्रगीत', titleEn: 'Prayers' },
          { id: 'gk', titleHi: '2. राजस्थान सामान्य ज्ञान', titleEn: 'Rajasthan GK' },
          { id: 'stories', titleHi: '3. प्रेरक प्रसंग (कहानियां)', titleEn: 'Inspirational' },
