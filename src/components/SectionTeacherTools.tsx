  ...
  return (
    <div className="space-y-5">
      ...
      {activeSubComponent !== 'kridaShulk' && (
        <div className="bg-white dark:bg-slate-900 rounded-xl sm:rounded-2xl p-2 sm:p-2.5 shadow-sm border border-slate-200 dark:border-slate-800 flex items-center justify-between gap-2">
          <div className="text-xs font-bold text-slate-700 dark:text-slate-300 flex items-center gap-1.5 px-1 sm:px-2">
            <Sparkles className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0" />
            <span className="truncate">{lang === 'hi' ? 'शिक्षक कार्यक्षेत्र' : 'Teacher Workspace'}</span>
          </div>
          ...
          <div className="flex items-center">
            <button
              ...
              className="px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-300/80 dark:border-slate-700 text-[11px] sm:text-xs font-extrabold text-slate-800 dark:text-slate-200 cursor-pointer whitespace-nowrap flex items-center space-x-1.5 transition-all"
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-md border border-slate-200 dark:border-slate-800 space-y-4">
              <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-800">
                <h3 className="font-black text-xs sm:text-sm text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
                  ...
                  <span>{lang === 'hi' ? 'कक्षा अध्यापक टूलकिट' : 'Class Teacher Toolkit'}</span>
                </h3>
                <span className="text-[11px] sm:text-xs font-bold text-slate-500 font-mono">Class: {selectedClass}</span>
              </div>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 gap-2.5 sm:gap-4">
                ...
                <ThreeDCard
                  ...
                  label={lang === 'hi' ? 'छात्र पंजीकरण' : 'Add Student'}
                />
                ...
                <ThreeDCard
                  ...
                  label={lang === 'hi' ? 'अंक प्रविष्टि' : 'Marks Feed'}
                />
                ...
                <ThreeDCard
                  ...
                  label={lang === 'hi' ? 'ग्रीनशीट' : 'Greensheet'}
                />
                ...
                <ThreeDCard
                  ...
                  label={lang === 'hi' ? 'परख अंकतालिका' : 'Test Marksheet'}
                />
                ...
                <ThreeDCard
                  ...
                  label={lang === 'hi' ? 'आपार रिपोर्ट' : 'APAAR Report'}
                />
                ...
                <ThreeDCard
                  ...
                  label={lang === 'hi' ? 'आधार रिपोर्ट' : 'Aadhaar Report'}
                />
                ...
                <ThreeDCard
                  ...
                  label={lang === 'hi' ? 'जनाधार रिपोर्ट' : 'Jan Aadhaar'}
                />
                ...
                <ThreeDCard
                  ...
                  label={lang === 'hi' ? 'डेटा एक्सपोर्ट' : 'Export Data'}
                />
